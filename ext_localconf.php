...
$GLOBALS['TYPO3_CONF_VARS']['SYS']['Objects']['DirectMailTeam\\DirectMail\\Module\\Dmail'] = array(
    'className' => 'Jokumer\\XtDirectmail\\Xclass\\Dmail',
);
 ...
 */
$TYPO3_CONF_VARS['EXTCONF']['direct_mail']['mod2']['getSingleMailGroup'][] = 'EXT:' . $_EXTKEY . '/Classes/Hooks/MailGroupHook.php:&Jokumer\XtDirectmail\Hooks\MailGroupHook';
$TYPO3_CONF_VARS['EXTCONF']['direct_mail']['mod3']['cmd_compileMailGroup'][] = 'EXT:' . $_EXTKEY . '/Classes/Hooks/MailGroupHook.php:&Jokumer\XtDirectmail\Hooks\MailGroupHook';
